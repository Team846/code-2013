 ...
 */
Error2& ErrorBase::GetError()
{
	return m_error;
}

const Error2& ErrorBase::GetError() const
{
	return m_error;
}
 ...
 * @param lineNumber Line number of the error source
 */
void ErrorBase::SetError(Error2::Code code, const char *contextMessage,
		const char* filename, const char* function, UINT32 lineNumber) const
{
	/*
	//  If there was an error
...
void ErrorBase::SetGlobalError(Error2::Code code, const char *contextMessage,
...
*/
Error2& ErrorBase::GetGlobalError()
{
	Synchronized mutex(_globalErrorMutex);
	return _globalError;
}
